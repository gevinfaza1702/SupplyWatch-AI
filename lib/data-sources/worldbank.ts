...
const WIDE_COLUMN_MAP: Record<string, { slug: string; unit: string }> = {
  ...
  "Rice, Thai 5%": { slug: "rice", unit: "USD/mt" },
  Maize: { slug: "corn", unit: "USD/mt" },
  Soybeans: { slug: "soybean", unit: "USD/mt" },
  Beef: { slug: "beef", unit: "USD/kg" },
  Chicken: { slug: "chicken", unit: "USD/kg" },
